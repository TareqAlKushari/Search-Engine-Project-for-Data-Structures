...
public:
    ...
    vector<string> get_possible_data_structures(string api) {
        ...
        /*
            An Array allows random access to any element in constant times,
                but it is slow in  insertion or delet element.
        */
        /* 
            A linked list allows dynamic allocation of memory and fast insertion or deletion at any position, 
                but it requires extra space for pointers and it is slow to access a random element.
        */
        /* 
            A binary tree allows fast search, insertion, and deletion of ordered data, 
                but it requires extra space for pointers and it may become unbalanced
        */
        /* 
            A hash table allows fast search, insertion, and deletion of unordered data, 
                but it requires a good hash function to avoid collisions and it may waste memory.
        */
        ...
        // sort(result.begin(),result.end(),[&](string ds1,string ds2)) { 
        //     return compare(ds1,ds2,api); 
        // }
